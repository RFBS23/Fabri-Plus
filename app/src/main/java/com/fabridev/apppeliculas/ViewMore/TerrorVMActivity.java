...
import com.fabridev.apppeliculas.databinding.ActivityTerrorBinding;
...
public class TerrorVMActivity extends AppCompatActivity {
    ActivityTerrorBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityTerrorBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Terror");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(TerrorVMActivity.this, LinearLayoutManager.VERTICAL, false));

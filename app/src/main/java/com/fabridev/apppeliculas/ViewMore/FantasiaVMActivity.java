...
import com.fabridev.apppeliculas.databinding.ActivityFantasiaVmactivityBinding;
...
public class FantasiaVMActivity extends AppCompatActivity {
    ActivityFantasiaVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityFantasiaVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Fantasía");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(FantasiaVMActivity.this, LinearLayoutManager.VERTICAL, false));

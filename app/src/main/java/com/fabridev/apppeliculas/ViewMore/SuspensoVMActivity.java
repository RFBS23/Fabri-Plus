...
import com.fabridev.apppeliculas.databinding.ActivitySuspensoBinding;
...
public class SuspensoVMActivity extends AppCompatActivity {

    ActivitySuspensoBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySuspensoBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("suspenso");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(SuspensoVMActivity.this, LinearLayoutManager.VERTICAL, false));

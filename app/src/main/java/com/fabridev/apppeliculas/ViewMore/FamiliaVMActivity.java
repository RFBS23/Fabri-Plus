...
import com.fabridev.apppeliculas.databinding.ActivityFamiliaVmactivityBinding;
...
public class FamiliaVMActivity extends AppCompatActivity {

    ActivityFamiliaVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityFamiliaVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Familia");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(FamiliaVMActivity.this, LinearLayoutManager.VERTICAL, false));

...
import com.fabridev.apppeliculas.databinding.ActivityCrimenVmactivityBinding;
...
public class CrimenVMActivity extends AppCompatActivity {
    ActivityCrimenVmactivityBinding binding;
    private FirebaseDatabase database;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityCrimenVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Crimen");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(CrimenVMActivity.this, LinearLayoutManager.VERTICAL, false));

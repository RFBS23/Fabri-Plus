...
import com.fabridev.apppeliculas.databinding.ActivityAventuraVmactivityBinding;
...
public class AventuraVMActivity extends AppCompatActivity {
    ActivityAventuraVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAventuraVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Aventura");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(AventuraVMActivity.this, LinearLayoutManager.VERTICAL, false));

...
import com.fabridev.apppeliculas.databinding.ActivityMusicalVmBinding;
...
public class MusicalVM extends AppCompatActivity {

    ActivityMusicalVmBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMusicalVmBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Musical");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(MusicalVM.this, LinearLayoutManager.VERTICAL, false));

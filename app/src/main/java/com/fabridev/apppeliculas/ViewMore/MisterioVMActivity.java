...
import com.fabridev.apppeliculas.databinding.ActivityMisterioVmactivityBinding;
...
public class MisterioVMActivity extends AppCompatActivity {
    ActivityMisterioVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMisterioVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Misterio");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(MisterioVMActivity.this, LinearLayoutManager.HORIZONTAL, false));

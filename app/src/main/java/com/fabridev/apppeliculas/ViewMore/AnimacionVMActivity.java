...
import com.fabridev.apppeliculas.databinding.ActivityAnimacionVmactivityBinding;
...
public class AnimacionVMActivity extends AppCompatActivity {
    ActivityAnimacionVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAnimacionVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Animacion");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(AnimacionVMActivity.this, LinearLayoutManager.VERTICAL, false));

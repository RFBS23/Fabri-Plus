...
import com.fabridev.apppeliculas.databinding.ActivityDramaVmactivityBinding;
...
public class DramaVMActivity extends AppCompatActivity {
    ActivityDramaVmactivityBinding binding;
    private FirebaseDatabase database;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDramaVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Dramas");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(DramaVMActivity.this, LinearLayoutManager.VERTICAL, false));

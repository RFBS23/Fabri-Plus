...
import com.fabridev.apppeliculas.databinding.ActivityGuerraVmactivityBinding;
...
public class GuerraVMActivity extends AppCompatActivity {
    ActivityGuerraVmactivityBinding binding;
    private FirebaseDatabase database;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityGuerraVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Guerra");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(GuerraVMActivity.this, LinearLayoutManager.VERTICAL, false));

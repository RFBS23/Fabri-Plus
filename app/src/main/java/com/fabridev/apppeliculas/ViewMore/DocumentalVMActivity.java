...
import com.fabridev.apppeliculas.databinding.ActivityDocumentalVmactivityBinding;
...
public class DocumentalVMActivity extends AppCompatActivity {

    ActivityDocumentalVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityDocumentalVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Documental");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(DocumentalVMActivity.this, LinearLayoutManager.VERTICAL, false));

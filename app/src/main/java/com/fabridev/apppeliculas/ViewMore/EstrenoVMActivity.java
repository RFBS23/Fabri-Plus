...
public class EstrenoVMActivity extends AppCompatActivity {
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Todos Los Estrenos");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(EstrenoVMActivity.this, LinearLayoutManager.VERTICAL, false));

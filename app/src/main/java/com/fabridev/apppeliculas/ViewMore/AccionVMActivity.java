...
import com.fabridev.apppeliculas.databinding.ActivityAccionVmactivityBinding;
...
public class AccionVMActivity extends AppCompatActivity {
    ActivityAccionVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAccionVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Acción");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(AccionVMActivity.this, LinearLayoutManager.VERTICAL, false));

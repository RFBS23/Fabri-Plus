...
import com.fabridev.apppeliculas.databinding.ActivityAnimesVmactivityBinding;
...
public class AnimesVMActivity extends AppCompatActivity {
    ActivityAnimesVmactivityBinding binding;
    private FirebaseDatabase database;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityAnimesVmactivityBinding.inflate(getLayoutInflater());
        ...
        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    if(!items.isEmpty()){
                        binding.TituloCatTxt.setText("Animes");
                        binding.movieListView.setLayoutManager(new LinearLayoutManager(AnimesVMActivity.this, LinearLayoutManager.VERTICAL, false));
